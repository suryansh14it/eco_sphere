...
export interface GreenCreditsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface GreenCredits extends BaseContract {
  connect(runner?: ContractRunner | null): GreenCredits;
  waitForDeployment(): Promise<this>;

  interface: GreenCreditsInterface;
